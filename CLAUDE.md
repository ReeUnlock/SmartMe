...
backend/alembic/    — migracje DB (18 plików, env.py importuje wszystkie modele)
...
- **Testy backend**: `docker exec anelka-backend python -m pytest tests/auth/ -v --tb=short` (62 testy, SQLite in-memory)
